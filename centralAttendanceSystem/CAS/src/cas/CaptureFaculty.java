...
import cas.AdminInterface;
import static cas.AdminInterface.photo;
...
import static cas.AdminInterface.photoLabel1;

/**
 *
 * @author hp
 */
public class CaptureFaculty extends javax.swing.JFrame {

    static {
        File file = new File("C:\\Users\\HP\\Documents\\NetBeansProjects\\CAS\\src\\required\\opencv_java249.dll");
    ...
    private void CaptureImage(JLabel image) {
        try {
            ...
            if (getImage != null) {
                ...
                ImageIcon imageico = new ImageIcon(new ImageIcon(Filename).getImage().getScaledInstance(photoLabel1.getWidth(), photoLabel1.getHeight(), Image.SCALE_DEFAULT));
                photoLabel1.setIcon(imageico);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, "Warning");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CaptureFaculty.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CaptureFaculty().setVisible(true);
            }
        });
    }
